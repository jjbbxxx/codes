...
import interface_.MusicTypeDao;
...
public class MusicTypeMysqlImpleDao implements MusicTypeDao {
    ...
    public MusicTypesEntity getMusicType(String id) throws SQLException, ClassNotFoundException {
        String sql="select type_name from music_types where type_id="+id;
        ...
        return (MusicTypesEntity) list;
    }
    @Override
    public int addMusicType(String id, String name) throws SQLException, ClassNotFoundException {
        String sql="insert into music_types values("+id+","+name+")";
        System.out.println(sql);
        Connection conn = MusicTypeMysqlImpleDao.getConnection();//连接
        PreparedStatement ps=conn.prepareStatement(sql);
    ...
    public void delMusicType(String id) throws SQLException, ClassNotFoundException {
        String sql="delete from music_types where type_id="+id;
        System.out.println(sql);
        Connection conn = MusicTypeMysqlImpleDao.getConnection();//连接
        PreparedStatement ps=conn.prepareStatement(sql);
        int count = ps.executeUpdate(sql);//执行
