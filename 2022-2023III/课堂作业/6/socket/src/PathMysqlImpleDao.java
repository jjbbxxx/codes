...
public class PathMysqlImpleDao implements PathDao {
    ...
    public PathEntity getPath(String id) throws SQLException, ClassNotFoundException {
        String sql="select path_name from path where path_id="+id;
        System.out.println(sql);
        Connection conn = PathMysqlImpleDao.getConnection();
        //创建Statement对象
        ...
        return (PathEntity) list;
    }
    @Override
    public int addPath(String id, String name) throws SQLException, ClassNotFoundException {
        String sql="insert into path values("+id+","+name+")";
        System.out.println(sql);
        Connection conn = PathMysqlImpleDao.getConnection();//连接
        PreparedStatement ps=conn.prepareStatement(sql);
    ...
    public void delPath(String id) throws SQLException, ClassNotFoundException {
        String sql="delete from path where path_id="+id;
        System.out.println(sql);
        Connection conn = PathMysqlImpleDao.getConnection();//连接
        PreparedStatement ps=conn.prepareStatement(sql);
        int count = ps.executeUpdate(sql);//执行
